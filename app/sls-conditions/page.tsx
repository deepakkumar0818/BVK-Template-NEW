...
export default function SlsConditionsPage() {
  return (
    <main className="conditions-doc" style={{ padding: '24px', maxWidth: '210mm', margin: '0 auto' }}>
      ...
      <div style={{ borderTop: '1px solid #000', paddingTop: '12px' }}>
        ...
        <div style={{ marginBottom: '10px' }}>
          However, if there is any change in Tax and any New Statutory Levies is introduced by Government at the time of delivery of the same
          will be billed as per actual.
        </div>
        <div style={{ marginBottom: '14px' }}>
