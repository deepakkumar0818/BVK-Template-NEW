  ...
  if (useWmwd1StyleLayout) {
    ...
    return (
      <>
        ...
        {/* Shared Standard Conditions of Sale (18 sections) — same for both
         * /wmw/[id] and /quotation/[id]. Sourced from
         * StandardConditionsOfSale.tsx so any future edit updates both. */}
        <StandardConditionsOfSale />

      <div className="no-print" style={{ marginTop: '24px', textAlign: 'center' }}>
        <Link
          href={wmwd1NotesRemarksFromApi ? '/conditions/quotation' : '/conditions'}
