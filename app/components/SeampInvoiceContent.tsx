...
import SeampGoodsTable from './SeampGoodsTable'

interface SeampInvoiceContentProps {
  data: QuotationData
  shippingData?: any
  billingData?: any
...
export default function SeampInvoiceContent({
  data,
  shippingData,
  billingData,
  rawQuotationData,
}: SeampInvoiceContentProps) {
    ...
    <>
      <div className="performa-invoice-content-section performa-invoice-content-section--seamless" style={{ marginBottom: '8px' }}>
        <SeampGoodsTable
          ...
          headerNode={
            <table
              className="seamp-quotation-header-table"
              style={{
                width: '100%',
