...
import EkamassGoodsTable from './EkamassGoodsTable'

interface EkamassInvoiceContentProps {
  data: QuotationData
  shippingData?: any
  billingData?: any
...
export default function EkamassInvoiceContent({
  data,
  shippingData,
  billingData,
  rawQuotationData,
}: EkamassInvoiceContentProps) {
    ...
    <>
      <div className="performa-invoice-content-section performa-invoice-content-section--seamless" style={{ marginBottom: '8px' }}>
        <EkamassGoodsTable
          ...
          headerNode={
            <table
              className="ekamass-quotation-header-table"
              style={{
                width: '100%',
