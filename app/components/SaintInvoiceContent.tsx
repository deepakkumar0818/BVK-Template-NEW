...
export default function SaintInvoiceContent({
  data,
  shippingData,
  billingData,
  rawQuotationData,
          ...
          headerNode={
            ...
            >
              <tbody>
                ...
                <tr>
                  <td style={{ width: '56%', verticalAlign: 'top', border: '1px solid #000', padding: 0 }}>
                        ...
                        <tr>
                          <td style={{ border: '1px solid #000', padding: '8px', verticalAlign: 'middle' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                              ...
                              <span style={{ textAlign: 'center' }}>{data.date || '24-Jun-24'}</span>
                            </div>
                          </td>
                        </tr>
                        <tr>
