...
function buildAddressRowPairs(
  ...
  const invRows = [
    ...addressLines(invoiceAddress),
    `CELL NO. - ${invoiceCell}`,
    `CONTACT PERSON: ${invoiceContact}`,
  ]
  const delRows = [
    ...addressLines(deliveryAddress),
    `CELL NO. - ${deliveryCell}`,
    `CONTACT PERSON: ${deliveryContact}`,
  ]
...
export default function BvkOrderDetailSheetContent() {
  const addressRows = buildAddressRowPairs(
    STATIC.invoiceAddress,
    STATIC.invoiceCell,
    STATIC.invoiceContact,
    STATIC.deliveryAddress,
    STATIC.deliveryCell,
    STATIC.deliveryContact
  )
        ...
        <tbody>
          <tr>
            ...
            <td colSpan={2} className="ods-doc-top">
              <span className="ods-label">DOC. NO. :</span> {STATIC.docNo}
              <span className="ods-doc-rev"> Rev : {STATIC.docRev}</span>
            </td>
            <LogoCell />
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td rowSpan={2}>{STATIC.odsDate}</td>
          ...
          <tr>
            ...
            <td colSpan={3}>{STATIC.clientName}</td>
          </tr>
        </tbody>
        </table>
      </div>
      ...
      <div className="ods-section-outline">
        <table className="ods-table ods-product-table" role="presentation">
          ...
          <tbody>
            ...
            <tr>
              <td colSpan={9} className="ods-product-foot-label">
                {STATIC.gstLabel}
              </td>
              <td className="ods-product-foot-value">{STATIC.gstAmount}</td>
            </tr>
            <tr>
              <td colSpan={9} className="ods-product-foot-label">
                Total Value
              </td>
              <td className="ods-product-foot-value">{STATIC.totalValue}</td>
            </tr>
          </tbody>
        </table>
      </div>
