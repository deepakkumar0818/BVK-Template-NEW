...
/**
 * Clone of sls-ods-no-44-p with the header logo swapped to BVK Hydrotech.
 * Everything else — 12-col layout, redacted prices, 5-row terms, remarks —
 * is identical.
 */
...
export const slsOds44PHydrotechFixture: SalesOrderData = {
  variant: 'sls-ods-44-p-hydrotech',
  logo: {
