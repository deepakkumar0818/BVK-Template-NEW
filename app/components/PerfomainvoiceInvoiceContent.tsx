...
import PerfomainvoiceGoodsTable from './PerfomainvoiceGoodsTable'

interface PerfomainvoiceInvoiceContentProps {
  data: QuotationData
  shippingData?: any
  billingData?: any
...
export default function PerfomainvoiceInvoiceContent({
  data,
  shippingData,
  billingData,
  rawQuotationData,
}: PerfomainvoiceInvoiceContentProps) {
  ...
  return (
    <>
      <div className="performa-invoice-content-section performa-invoice-content-section--seamless" style={{ marginBottom: '8px' }}>
        <PerfomainvoiceGoodsTable
          data={data}
          rawQuotationData={rawQuotationData}
          shippingData={shippingData}
          headerNode={
            <table
              className="perfomainvoice-quotation-header-table"
              style={{
                width: '100%',
