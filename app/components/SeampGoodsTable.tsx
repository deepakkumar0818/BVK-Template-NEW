...
interface SeampGoodsTableProps {
  data: QuotationData
...
export default function SeampGoodsTable({ data, rawQuotationData, shippingData, headerNode, footerNode }: SeampGoodsTableProps) {
              ...
              >
                ...
                <tbody>
                  ...
                  {groupChunkRowsByProductFormQuality(chunk).map((groupRows, groupIdx) => {
                    ...
                    return (
                      <Fragment key={`seamp-grp-${pageIdx}-${groupIdx}`}>
                        ...
                        {groupRows.map((row, rowIdx) => (
                          <tr key={`seamp-line-${pageIdx}-${groupIdx}-${rowIdx}`} className="seamp-item-grid-row">
                            <td colSpan={2} style={{ ...bdItemGrid, padding: '6px 10px', verticalAlign: 'middle' }}>
                  ...
                  {isLastChunk && (
                    <>
                      ...
                      <tr>
                        ...
                        <td colSpan={4} style={{ ...bd, padding: '4px 8px', fontWeight: 'bold', verticalAlign: 'middle', fontSize: '11px', width: '58%' }}>
